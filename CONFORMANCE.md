...
Conformance beschreibt, wann ein Tool, Playbook, Quest-System oder KI-Agent behaupten darf, Teile des Real Life Network Protocols zu unterstuetzen.
...
2. Ablehnung, Nicht-Reaktion und Rueckzug als normale Ergebnisse behandeln.
3. Beziehungen und reale Begegnungen staerken, nicht ersetzen.
...
8. KI-Agenten als unterstuetzend, nicht steuernd behandeln.
...
- die Kernentitaeten nicht widerspruechlich verwendet,
...
- analoge oder organisatorische Fallbacks fuer technische Ausfaelle vorsieht.
...
- den Zweck jeder Quest auf Beziehung, Commons, lokale Resilienz oder gemeinsames Handeln zurueckfuehrt.

### `rlnp-agent@0.1`

Eine Umsetzung ist `rlnp-agent@0.1`-konform, wenn sie:

- Agenten eine erkennbare Identitaet gibt,
- Vorschlaege als Einladungen formuliert,
- menschliche Entscheidungen nicht ersetzt,
- nur mit Kontext arbeitet, fuer den Sichtbarkeit und Zustimmung bestehen.

## Noch offen

- Maschinenlesbares Conformance-Manifest.
- Testfaelle fuer Agentenverhalten.
- Schema-Validatoren fuer Datenmodelle.
- Checklisten fuer Playbooks und Rollout-Slices.
