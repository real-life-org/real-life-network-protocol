...
- Quest-Autorenschaft, Sichtbarkeit, Fertig-Meldung, Evidence und Bezeugung nachvollziehbar modelliert,
...
- `evidencePolicy`, `confirmationPolicy`, `completionConfirmationTemplate` und `safetyRequirements` als Regeln des Basisprotokolls behandelt, nicht als Game-Mechaniken, und die Vergabe von Badges umgekehrt als Game-Mechanik behandelt, nicht als Protokollpflicht,
...
- Angebote und Bedürfnisse in Rollout v0.1 als einfache Profil-Tags behandeln kann, auch wenn sie zunächst aus dem WoT-Profil kommen und in der RLS-Referenz noch nicht vollständig implementiert sind,
