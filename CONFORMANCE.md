...
- Quest-Autorenschaft, Sichtbarkeit, lokale Completion, Evidence, Attestation und Badge-Vergabe nachvollziehbar modelliert,
...
- QR-Scans, Host-Bestätigungen, gegenseitige Bestätigungen und Systemereignisse als Evidence, Trigger oder Issuer-Rollen für Attestations behandelt, nicht als eigene portable Wahrheitsarten,
- `attestationPolicy`, `requiredEvidence`, `completionAttestationTemplate` und `safetyRequirements` als Quest-Completion-Logik behandelt, nicht als Game-Mechaniken,
- nur solche Attestations als Quest-Completion zählt, die zu einer vorhandenen `attestationPolicy` passen,
